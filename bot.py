...
BOT_TOKEN   = os.environ.get("BOT_TOKEN", "")        # Render → Environment → BOT_TOKEN
ADMIN_ID    = 8379167923
WEBHOOK_URL = os.environ.get("WEBHOOK_URL", "")      # e.g. https://your-app.onrender.com
PORT        = int(os.environ.get("PORT", 10000))     # Render auto-sets PORT
...
def main():
    ...
    logger.info("🤖 Bot start ho raha hai... (Webhook mode)")
    ...
    logger.info(f"🚀 Webhook start ho raha hai → {full_webhook_url}")
